...
public interface BlFacade  {
	...
	@WebMethod public User registerNewAdmin(String username, String password);
	...
	@WebMethod public void placeBet(float stake, String username,fee f, Question q, Event e);
